...
<Note>
For workloads that remain deferred for long periods, connect [infrastructure metrics](/resources/metrics/index). Arklow continues operating without them, but delayed settlement makes capacity decisions less precise.
</Note>
