...
Work arrives from your services and queues. Arklow accepts it durably, routes it, and holds excess demand until the destination can absorb it.
...
<Columns cols={2}>
  ...
  >
    Connect protected work to capacity and choose whether Arklow records or applies scaling decisions.
  </Card>
</Columns>
