...
While the scale-targets member of [Write Control](https://app.arklow.io/dashboard/settings?tab=organization) is off, adjustments are recorded and not written. While it is on, Arklow writes replica counts within the target's configured range.
