...
Both values come from the accepted scale setting and remain within the target's configured replica range.
...
<Steps>
  ...
  <Step title="Open scale targets">
    Go to [**Scale Targets**](https://app.arklow.io/dashboard/scale-targets), click **New manual target**, and select **HTTP scale API (floor)**.
  </Step>
