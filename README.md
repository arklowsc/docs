...
The actual end domain is hosted on https://arklowdocs.io, partly down to it being better practice to avoid domain-scoped cookies from being misused, and equally partly because Mintlify doesn't have a great history for Security. So it gets it's own blast chamber... eh domain!